              ...
              <CardBody>
                <DefList
                  items={[
                    ...
                    { label: "Backend", value: "FastAPI (not connected)" },
                    { label: "Data source", value: "Local fixtures" },
                    { label: "AI service", value: "Not connected" },
                  ]}
                />
              </CardBody>
              <CardFoot>
                <span className="t-caption row row--tight">
                  ...
                  Service figures above are fixtures until the operational endpoints
                  are connected
                </span>
              </CardFoot>
            </Card>
